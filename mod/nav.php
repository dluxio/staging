    ...
    <div class="mr-5" id="active-session">
	  <ul class="nav navbar-nav">
		<li class="nav-item my-auto">
			<button type="button" class="nav-link" href="../new/" data-toggle="tooltip" data-placement="bottom" title="Create a new app">
				<i class="far fa-fw fa-lg fa-lightbulb mr-2"></i></button></li>
