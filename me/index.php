...
function pageSpecfic(usr){
	...
	document.getElementById('dluxval').firstElementChild.innerText = `$${parseFloat((parseInt(usr.dlux.balance) + parseInt(usr.dlux/poweredUp))*usr.dex.hive.tick*usr.price).toFixed(2)}`
}	
