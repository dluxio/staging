  ...
  <div class="modal-content bg-dark text-white">
	  ...
	  <div class="float-left" ><a dmx-bind:href="/@{{author}}"><img dmx-bind:src="https://token.dlux.io/getauthorpic/{{author}}" alt="" class="rounded-circle bg-light img-fluid mr-2 cover author-img"></a></div>
        <div class="float-left">
          <p class="mt-0 mb-0 text-muted text-semibold"><a dmx-bind:href="/@{{author}}" class="a-1">{{dluxPost.data.result.author}}<span class="ml-2 badge badge-pill badge-light">{{dluxPost.data.result.author_reputation.toString().rep()}}</span></a></p>
