    ...
    <div class="container-fluid bg-light">
	  <div class="row">
		  <div class="col-xl-4">
			  ...
			  <p><img src="images/smart-img.png" class="img-fluid rounded" alt="smart"></p>
	    ...
	    <div class="col-xl-4">
	    	...
	    	<p><img src="images/secure-img.png" class="img-fluid rounded" alt="secure"></p>
	    ...
	    <div class="col-xl-4">
	    	...
	    	<p><img src="images/compatible-img.png" class="img-fluid rounded" alt="compatible"></p>
